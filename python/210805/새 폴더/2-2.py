...
scatter 산점도.. 그래프 그리는거
'''

# bream 도미.. 큰물고기 35개
# smelt 빙어.. 작은물고기 14개

# 큰 물고기 작은물고기... 판별해주는 프로그램...
...
'''
(실제데이터-평균값) / 표준점수...
x좌표축의 데이터 범위와 y좌표축의 데이터 범위가 다를 때는 데이터전처리...
표준점수로... 구해주어야 한다..

train_scaled -> 표준점수... 나온... 훈련 데이터
kneighborsclassfier 학습기에다가 학습시켜서...
neibores() 제일 가까운 좌표 5개를 구합니다.
5개 데이터를 그래프에다가 시각화를 합니다.
'''
